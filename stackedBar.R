...
count <- c(sum(ogData$network>secondMark), sum(ogData$network>=firstMark&ogData$network<=secondMark), sum(ogData$network<firstMark),
           ...
           sum(ogData$sensitivity>secondMark), sum(ogData$sensitivity>=firstMark&ogData$sensitivity<=secondMark), sum(ogData$sensitivity<firstMark), 
           sum(ogData$clperms>secondMark), sum(ogData$clperms>=firstMark&ogData$clperms<=secondMark), sum(ogData$clperms<firstMark), 
           sum(ogData$fsperms>secondMark), sum(ogData$fsperms>=firstMark&ogData$fsperms<=secondMark), sum(ogData$fsperms<firstMark))
